...
public class RenderHelper
{
	...
	public static void drawRectPrism(float x1, float x2, float y1, float y2, float z1, float z2)
	{
		...
		if (topTexture == null) glBindTexture(GL_TEXTURE_2D, 0);
		else topTexture.bindTexture();
		...
		if (btmTexture == null) glBindTexture(GL_TEXTURE_2D, 0);
		else btmTexture.bindTexture();
		...
		if (lftTexture == null) glBindTexture(GL_TEXTURE_2D, 0);
		else lftTexture.bindTexture();
		...
		if (rgtTexture == null) glBindTexture(GL_TEXTURE_2D, 0);
		else rgtTexture.bindTexture();
		...
		if (bckTexture == null) glBindTexture(GL_TEXTURE_2D, 0);
		else bckTexture.bindTexture();
		...
		if (fntTexture == null) glBindTexture(GL_TEXTURE_2D, 0);
		else fntTexture.bindTexture();
